...
package RPNStacker.Postfix.src.postfix.interpreter;
...
public class Interpreter implements Expr.Visitor<Integer> {
	...
	public final HashMap<String, String> env; //mudando para inserção de ids
	...
	@Override
	public Integer visitIDExpr(Expr.ID expr) { //adicionando ids
